// app/data/checklist.js

export const CHECKLIST_ITEMS = [
  {
    kategori: "A. Dokumen Lingkungan (Admin)",
    items: [
      "Dokumen AMDAL/DELH, UKL-UPL/DPLH, atau SPPL",
      "Persetujuan Lingkungan (SK)",
      "Persetujuan Teknis (Pertek)",
      "Pelaporan Semesteran Pelaksanaan Lingkungan"
    ]
  },
  {
    kategori: "B. Pengendalian Pencemaran Air (Limbah Cair)",
    items: [
      "Kondisi fisik IPAL (Permanen, Kedap Air)",
      "Kondisi kinerja IPAL (Peralatan berfungsi baik)",
      "Ketersediaan Alat Ukur Debit (Flowmeter Inlet/Outlet)",
      "Pencatatan Debit Harian (Logbook)",
      "Kesesuaian Saluran Air Limbah (Tertutup/Kedap)",
      "Pengelolaan Lumpur (Sludge) IPAL"
    ]
  },
  {
    kategori: "C. Pengendalian Pencemaran Udara",
    items: [
      "Ketersediaan Alat Pengendali Emisi (Filter/Scrubber)",
      "Lubang Sampling pada Cerobong (Sesuai Kaidah)",
      "Tangga dan Platform Sampling yang Aman",
      "Data Hasil Uji Emisi Terbaru",
      "Data Hasil Uji Udara Ambien"
    ]
  },
  {
    kategori: "D. Pengelolaan Limbah B3",
    items: [
      "Izin/Pertek Penyimpanan Sementara LB3",
      "Kondisi Bangunan TPS LB3 (Atap, Lantai Kedap, Penerangan)",
      "Pemasangan Simbol dan Label pada Kemasan",
      "Pencatatan Neraca Limbah B3",
      "Pencatatan Logbook Limbah B3",
      "Masa Simpan Limbah (Sesuai Izin)"
    ]
  },
